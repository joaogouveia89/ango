...
// thanks to https://stackoverflow.com/questions/990904/remove-accents-diacritics-in-a-string-in-javascript
...
$(document).on('turbolinks:load',function(){
	...
	$("select[name='sel_product_quantity']").change(function(){
	 ...
	 $("#searchField").keyup(function(){
	 	...
	 	var query = $(this).val().latinise();
	 	var table = document.getElementById("productTable");
	 	var rows = table.getElementsByTagName("tr");
	 	for(i = 1; i < rows.length; i++){
	 		var productName = rows[i].getElementsByTagName("td")[0].innerText;
	 		if (productName.latinise().toUpperCase().indexOf(query.toUpperCase()) > -1) {
